...
export default function SignupPage() {
  ...
  const onSubmit = async (values) => {
    ...
    // Implementation for signup will go here
  };
    ...
    >
      <Card className="border-none shadow-xl bg-background/60 backdrop-blur-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription>
            Enter your information to get started with Traveloop
          </CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4">
          <Button 
            variant="outline" 
            className="w-full bg-background hover:bg-muted transition-all duration-300"
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
              ...
              />
              <Button type="submit" className="w-full bg-primary hover:bg-primary/90 transition-all duration-300">
                Create Account
              </Button>
            </form>
          </Form>
